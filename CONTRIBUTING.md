...
- In `apps/site`, change only the docs pages (`apps/site/content/docs`). The rest of the Site (the marketing page, demo, design, and build) is maintained by the project; a check fails PRs that change it. To suggest a change there, open an issue.
