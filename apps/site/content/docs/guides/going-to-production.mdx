...
GridCue's published evidence is scoped to one schema: 176 labelled live requests on a synthetic wealth schema, 0 wrong views (jev-1.13.0, Sept 2026). Your columns, aliases, and Users' wording are different. Write labelled cases for your schema and run them with live Jev before launch, and again after any model, strategy, or schema change. Treat any unsafe result as release-blocking. See [Running evals](/docs/guides/evals).
